<template>
    <div class="checkbox-container">
        ...
        <pk-divider>禁用</pk-divider>
        <pk-checkbox-group disabled>
            <pk-checkbox>禁用</pk-checkbox>
            <pk-checkbox>禁用</pk-checkbox>
            <pk-checkbox>禁用</pk-checkbox>
            <pk-checkbox :disabled="false">非禁用</pk-checkbox>
        </pk-checkbox-group>
        <pk-divider>大小</pk-divider>
