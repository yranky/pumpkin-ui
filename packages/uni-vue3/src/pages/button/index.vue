<template>
  <view class="button-container">
    ...
    <view class="button-row">
      <pk-button type="primary" color="#65da79">自定义颜色</pk-button>
