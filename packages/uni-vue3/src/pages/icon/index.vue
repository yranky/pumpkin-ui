<template>
    <view class="icon-container">
        ...
        <pk-icon name="https://at.douyeblog.top/anydoor/www/anydoor_www@2.2.0/favicon.ico" :size="60"></pk-icon>

        <template v-for="type in icons" :key="type.title">
            <pk-divider>全部图标-{{ type.title }}</pk-divider>
            <view class="icon-items">
                <view class="icon-item" v-for="item in type.items" :key="item" @click="copySelect(item)">
                    <view class="icon">
...
import PkIcon from '@/pk-ui/components/pk-icon/pk-icon.vue'
